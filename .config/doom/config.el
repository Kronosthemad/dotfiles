...
(setq user-full-name "Eli Weatherby"
      user-mail-address "chemicalorca22@gmail.com")
...
(map! :leader
      (:prefix-map ("t" . "toggle")
       :desc "Tab next" "k" #'tab-next))
(map! :leader
      (:prefix-map ("t" . "toggle")
       :desc "Tab next" "j" #'tab-previous))
...
(map! :leader
      (:prefix ("r" . "eradio")
       :desc "Toggle the radio player" "t" 'eradio-toggle))
...
(setq eradio-channels '(("def con - soma fm" . "https://somafm.com/defcon256.pls")          ;; electronica with defcon-speaker bumpers
                        ...
                        ("ozzy - pandora"    . "https://www.pandora.com/station/135055214410476778")
